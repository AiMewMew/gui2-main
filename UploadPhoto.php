                        ...
                        <form method='post' enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                               ...
                               <option>  </option>
                                ...
                                <label class="label-control" for="posttype">Photo Type</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="file" class="form-control-input" name='file' required>
                                <label class="label-control" for="photo">Choose Photo</label>
                                <div class="help-block with-errors"></div>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="submit" class="form-control-submit-button" value="Upload Photo" name="UploadPhoto" >
                            </div>
