    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Text Logo - Use this if you don't have a graphic logo -->
             <a class="navbar-brand logo-text page-scroll" href="Admin.php">E-Network</a> 
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
                        <a class="nav-link page-scroll" href="Admin.php">MANAGE ACCOUNT </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="Admin.php?PageName=ManageCategory">MANAGE CATEGORY</a>
                    </li>
